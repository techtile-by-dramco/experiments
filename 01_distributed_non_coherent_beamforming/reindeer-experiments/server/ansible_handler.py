...
def ansible_copy_files(user_name, exp_dir, ansible_config_yaml, client_config_yaml, client_experiment_name):    
    r = ansible_runner.run(
        ...
        playbook=f"/home/{user_name}/ansible/experiments/{ansible_config_yaml.get('copy_client_script')}",
...
def ansible_stop_client_script(user_name, tiles_to_kill, ansible_config_yaml):
    r = ansible_runner.run(
        inventory=f'/home/{user_name}/ansible/inventory/{ansible_config_yaml.get("inventory")}',
        playbook=f'/home/{user_name}/ansible/experiments/{ansible_config_yaml.get("stop_client_script")}',
