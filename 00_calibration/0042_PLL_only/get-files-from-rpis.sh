...
sshpass -p "$password"  ssh techtile@192.108.0.1 -t "scp pi@rpi-t03.local:~/experiments/00_calibration/0042_PLL_only/data_T03_* /storage/gilles/0042_PLL_only/"
...
sshpass -p "$password"  ssh techtile@192.108.0.1 -t "scp pi@rpi-t02.local:~/experiments/00_calibration/0042_PLL_only/data_T02_* /storage/gilles/0042_PLL_only/"
