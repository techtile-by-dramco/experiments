...
def measure_channel_coherence(usrp, tx_streamer, rx_streamer, quit_event):
...
def main():
    ...
    try:
        ...
        measure_channel_coherence(usrp, tx_streamer, rx_streamer, quit_event)
        ...
        # decimated_results = signal.decimate(
        #     results, q=100, ftype="fir", axis=-1, zero_phase=True
        # )
